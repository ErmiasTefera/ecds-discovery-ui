...
export const mockDetailResources: DetailResource[] = [
  {
    ...
    thumbnailUrl: 'https://api.dicebear.com/7.x/shapes/svg?seed=healthcare-ml',
  ...
  },
  {
    ...
    thumbnailUrl: 'https://api.dicebear.com/7.x/shapes/svg?seed=computer-vision',
  ...
  },
  {
    ...
    thumbnailUrl: 'https://api.dicebear.com/7.x/shapes/svg?seed=climate-food',
  ...
  },
  {
    ...
    thumbnailUrl: 'https://api.dicebear.com/7.x/shapes/svg?seed=quantum-optimization',
  ...
  },
  {
    ...
    thumbnailUrl: 'https://api.dicebear.com/7.x/shapes/svg?seed=ai-ethics',
  ...
  },
  {
    ...
    thumbnailUrl: 'https://api.dicebear.com/7.x/shapes/svg?seed=nlp-neural',
