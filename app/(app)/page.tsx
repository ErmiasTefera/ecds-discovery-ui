          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="mb-8">
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-foreground mb-6 leading-tight">
                <span className="text-primary block">IPHCE RC Discovery Access</span>
              </h1>
              <p className="text-xl md:text-2xl text-muted-foreground mb-8 leading-relaxed">
              Access scholarly resources from our library catalog, institutional repositories, subscription databases, and open-access archives in one place.
              </p>
            </div>
